 ...
 */
 ...
 /* Test program that creates two Rectangle objects-
...
public class RectangleTest{
	...
	public static void main(String[] args) {
		...
		//Display the width, height, area, perimeter of each rectangle1
		System.out.println("\n Rectangle 1");
		System.out.println("-------------");
		...
		////Display the width, height, area, perimeter of each rectangle2
		System.out.println("\n Rectangle 2");
		System.out.println("-------------");
